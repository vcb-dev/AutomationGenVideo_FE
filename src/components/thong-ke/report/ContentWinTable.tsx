                    ...
                    <td className="py-3.5 px-4 text-xs text-center">
                      {isMock ? '-' : (
                        <select
                          ...
                          className="bg-[#131d31]/30 hover:bg-[#131d31]/60 border border-white/5 hover:border-white/10 focus:border-blue-500/40 outline-none rounded-lg px-2 py-1.5 text-[11px] font-bold text-slate-300 w-full cursor-pointer transition-all duration-150"
                        >
