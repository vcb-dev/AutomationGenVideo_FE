...
import { TrendingUp, Video, Award, XCircle, ChevronDown, Plus, Trash2 } from 'lucide-react';
import { EditorPerfItem } from '../types';
import { formatWinRate } from '../utils';

interface EditorWinStatsSectionProps {
  editorPerformance: EditorPerfItem[];
  win5Stats: { total: number; win: number; fail: number; percent: string };
  multiplier: number;
...
export default function EditorWinStatsSection({
  editorPerformance, win5Stats, multiplier, winFilterRatio, totalFilterRatio,
