    ...
    <div className="flex flex-col rounded-xl overflow-hidden border border-emerald-200 dark:border-emerald-500/20 shadow-lg shadow-emerald-950/10">
      ...
      >
        <span className="text-emerald-700 dark:text-emerald-400 font-black tracking-wider text-sm uppercase flex items-center gap-2">
          <CheckCircle className="w-4 h-4 text-emerald-700 dark:text-emerald-400" /> Content mới win của cá nhân trong team/trên số video đã làm
        </span>
      ...
      {!isCollapsed && (
        <div className="bg-card p-6 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-muted border border-border rounded-xl p-4 flex items-center justify-between transition-all hover:border-emerald-500/20 shadow-md">
                <div className="flex flex-col">
                  <span className="text-[12px] font-extrabold text-muted-foreground uppercase tracking-wider">Tổng Video Team</span>
                ...
                <div className="w-10 h-10 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center border border-emerald-200 dark:border-emerald-500/20">
                  <Video className="w-5 h-5 text-emerald-700 dark:text-emerald-400" />
                </div>
              </div>
              <div className="bg-muted border border-border rounded-xl p-4 flex items-center justify-between transition-all hover:border-emerald-500/20 shadow-md">
                <div className="flex flex-col">
          ...
          <div>
            <h3 className="text-xs font-extrabold text-muted-foreground uppercase tracking-wider mb-3">CỦA CÁ NHÂN (10K VIEW)</h3>
