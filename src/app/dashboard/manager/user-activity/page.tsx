                    ...
                    {activeTab === "dashboard" ? (
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                            {typeParam === "traffic" ? (
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                                {(isAdminUser || !isLeaderUser) && (
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-sm text-slate-400 font-medium leading-relaxed">
                                                            Dành cho Editor & Content báo cáo tiến độ checklist và khó khăn hàng ngày.
                                                        </p>
                                                        <div className="mt-8 flex items-center gap-2 text-blue-500 font-black text-xs uppercase tracking-widest">
                                                ...
                                                {(isAdminUser || isLeaderUser) && (
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-sm text-slate-400 font-medium leading-relaxed">
                                                            Dành cho Team Leader đánh giá chất lượng và quản lý nhân sự hàng ngày.
                                                        </p>
                                                        <div className="mt-8 flex items-center gap-2 text-indigo-500 font-black text-xs uppercase tracking-widest">
                                ...
                                // Fallback: không có type param hợp lệ
