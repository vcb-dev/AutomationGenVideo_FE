    ...
    <div className="flex flex-col gap-5">
            ...
            <div className="w-10 h-10 rounded-full bg-slate-100 overflow-hidden flex-shrink-0">
              <img
                ...
                onError={e => {
                  ...
                  if (pageInfo.avatar_url && target.src !== pageInfo.avatar_url) {
                    target.src = pageInfo.avatar_url;
                  }
                }}
              />
            </div>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <input
          ...
          className="w-28 px-3 py-2 text-sm border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20"
        />
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-4 bg-white rounded-xl border border-slate-200">
          ...
          <p className="text-sm text-slate-400 text-center max-w-sm">
            Thử thay đổi bộ lọc hoặc giảm ngưỡng views.
          </p>
        </div>
      ) : (
        <>
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-4">
              <p className="text-sm text-slate-500">
                Trang {page}/{totalPages} ({totalCount} video)
              </p>
