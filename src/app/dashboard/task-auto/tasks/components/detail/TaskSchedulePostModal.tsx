...
const PLATFORM_UI: Record<SocialPlatform, { label: string; color: string; svg?: string }> = {
  ...
  TIKTOK: {
    ...
    svg: 'M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.33 6.33 0 0 0-1-.08A6.34 6.34 0 0 0 3 15.66a6.34 6.34 0 0 0 10.82 4.49 6.31 6.31 0 0 0 1.96-4.49V8.65a8.28 8.28 0 0 0 3.81 1.48v-3.44z',
  },
}
const PLATFORM_ORDER: SocialPlatform[] = ['FACEBOOK', 'INSTAGRAM', 'YOUTUBE', 'THREADS', 'TIKTOK']
