          ...
          <div className="px-4 pb-4 space-y-4">
            ...
            {pagesLoading || syncing ? (
              ...
              <div className="bg-white dark:bg-card rounded-xl border border-border overflow-hidden">
                <div className="grid grid-cols-[auto_1fr_auto_auto_auto_auto] gap-4 px-5 py-3 bg-slate-50 dark:bg-slate-800/50 border-b border-border text-xs font-semibold text-slate-500 uppercase tracking-wider">
