...
import { Users, VideoCamera, ArrowsClockwise, BookmarkSimple, Timer, CircleNotch, SealCheck, Heart } from '@phosphor-icons/react';
import { BilibiliProfile } from '@/services/scraperService';
...
export default function BilibiliProfileCard({ profile: p, onScrape, onToggleBookmark, onToggleTracked, onViewDetail, onDelete, onEditClassification }: Props) {
      ...
      <div className="flex items-center gap-3 p-3.5 pb-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1">
            <p className="text-sm font-semibold text-foreground truncate">{p.nickname || p.mid}</p>
