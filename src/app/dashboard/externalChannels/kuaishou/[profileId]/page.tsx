...
import {
  ...
  ArrowsClockwise, BookmarkSimple, Timer, CircleNotch, FilmReel,
} from '@phosphor-icons/react';
import toast from 'react-hot-toast';

import { useAuthStore } from '@/store/auth-store';
import { scraperService, KuaishouVideo } from '@/services/scraperService';
...
function VideoCard({ video }: { video: KuaishouVideo }) {
  return (
    <a
      href={video.url}
      target="_blank"
